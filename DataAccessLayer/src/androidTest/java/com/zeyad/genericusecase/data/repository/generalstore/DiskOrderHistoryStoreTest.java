...
public class DiskOrderHistoryStoreTest {

    private DiskDataStoreRobotInterface mDiskDataStoreRobot;
    private DataStore mDiskDataStore;

    @Rule
    public Timeout mTimeout = new Timeout(5000, TimeUnit.MILLISECONDS);
    @Rule
    ...
    public void setUp() throws Exception {
        final DataBaseManager dbManager
                = DatabaseManagerFactory.getInstance(InstrumentationRegistry.getContext());
        final TestModelViewModelMapper enitityMapper
                = new TestModelViewModelMapper();
    ...
    public void testGetAll_ifNoErrorIsThrown_whenGetMethodIsCalled() {
        ...
        mDiskDataStore.dynamicGetList(Mockito.anyString(), mDiskDataStoreRobot.getDomainClass(),
                mDiskDataStoreRobot.getDataClass(), false, false)
    ...
    public void testGetObject_ifNoErrorIsThrown_whenIdColumnIsUsed() {
        ...
        mDiskDataStore
                .dynamicGetObject(null, "id", testModelId, null, mDiskDataStoreRobot.getDataClass(),
                        false, false)
                .subscribe(subscriber);
        TestUtility.assertNoErrors(subscriber);
    }
    ...
    public void testGetObject_ifSubscriberReceivesEvent_whenIdColumnIsUsed() {
        ...
        final TestSubscriber<Object> subscriber = new TestSubscriber<>();
        mDiskDataStore
                .dynamicGetObject(null, "id", testModelId, mDiskDataStoreRobot.getDomainClass(),
                        mDiskDataStoreRobot.getDataClass(), false, false)
                .subscribe(subscriber);
        assertThat("id searched for:" + testModelId, subscriber.getOnNextEvents(), allOf(notNullValue(),
                iterableWithSize(1)));
    }
    ...
    public void testGetObject_ifTestModelIsReturned_whenIdColumnIsUsed() {
        ...
        mDiskDataStore
                .dynamicGetObject(null, "id", testModelId, null, mDiskDataStoreRobot.getDataClass(),
                        false, false)
                .subscribe(subscriber);
        assertThat(subscriber.getOnNextEvents().get(0), allOf(notNullValue(),
                instanceOf(mDiskDataStoreRobot.getDomainClass())));
    }
    ...
    public void testGetObject_ifTestModelHasIdAsExpected_whenIdColumnIsUsed() {
        ...
        mDiskDataStore
                .dynamicGetObject(null, "id", testModelId, null, mDiskDataStoreRobot.getDataClass(),
                        false, false)
                .subscribe(subscriber);
        assertThat(((TestViewModel) subscriber.getOnNextEvents().get(0)).getTestInfo(),
                is(equalTo(mDiskDataStoreRobot.getTestInfo(testModelId))));
    }
    ...
    public void testSearchDisk_ifNoErrorIsThrown_whenDiskIsSearchedUsingValue() {
        mDiskDataStoreRobot.insertTestModels(10);
        final TestSubscriber<List> subscriber = new TestSubscriber<>();
        mDiskDataStore.searchDisk(mDiskDataStoreRobot.getPrefixForTestModel(), "value", null,
                mDiskDataStoreRobot.getDataClass())
                .subscribe(subscriber);
        TestUtility.assertNoErrors(subscriber);
    }
    ...
    public void testSearchDisk_ifCorrectItemsTypeIsReturned_whenDiskIsSearchedUsingValue() {
        ...
        mDiskDataStore.searchDisk(mDiskDataStoreRobot.getPrefixForTestModel(), "value", null,
                mDiskDataStoreRobot.getDataClass())
                .subscribe(subscriber);
        assertThat(((List<Object>) subscriber.getOnNextEvents().get(0)).get(0),
                is(instanceOf(mDiskDataStoreRobot.getDomainClass())));
    }
