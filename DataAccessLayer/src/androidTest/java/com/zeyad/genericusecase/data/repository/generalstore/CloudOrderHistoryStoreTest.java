...
public class CloudOrderHistoryStoreTest {
    ...
    public CloudOrderHistoryStoreTest(boolean callRealMethodsOfEntityMapper, boolean toPersist, boolean toCache) {
    ...
    @Test
    public void testDynamicPutHashMap_ifEntityMapperIsNotInvokedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreEnabledAndDeviceDoesNotHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, true);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, false);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
    ...
    @Test
    public void testDynamicPutHashMap_ifEntityMapperIsNotInvokedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreDisabledAndDeviceDoesHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, false);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, true);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
    ...
    @Test
    public void testDynamicPutHashMap_ifEntityMapperIsNotInvokedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreEnabledAndDeviceDoesHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, true);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, true);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
    ...
    public void testDynamicPutList_ifDataIsPersistedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreEnabledAndDeviceDoesNotHaveLollipop() {
        ...
        CloudDataStoreTestRobot.dynamicPutList(mCloudDataStore, mToPersist);
        final DataBaseManager verify = Mockito.verify(mMockedDBManager, times(mToPersist ? 1 : 0));
        verify.put(Mockito.any(JSONObject.class), eq(CloudDataStoreTestRobot.getValidColumnName()), eq(CloudDataStoreTestRobot.getValidDataClass()));
    }
    ...
    @Test
    public void testDynamicUploadFile_ifDataIsPersistedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreEnabledAndDeviceDoesNotHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, true);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, false);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
        ...
        assumeFalse(CloudDataStoreTestRobot.hasLollipop(mCloudDataStore));
        CloudDataStoreTestRobot.dynamicUploadFile(mCloudDataStore, mToPersist);
        Mockito.verifyNoMoreInteractions(mEntityMapper);
    }

    @Test
    public void testDynamicUploadFile_ifEntityMapperIsNotInvokedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreEnabledAndDeviceDoesNotHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, true);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, false);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
    ...
    @Test
    public void testDynamicUploadFile_ifEntityMapperIsNotInvokedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreDisabledAndDeviceDoesHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, false);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, true);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
    ...
    @Test
    public void testDynamicUploadFile_ifEntityMapperIsNotInvokedAccordingToPersistStatus_whenNetworkIsNotAvailableAndPlayServicesAreEnabledAndDeviceDoesHaveLollipop() {
        CloudDataStoreTestRobot.changeNetworkState(mMockedDBManager, false);
        CloudDataStoreTestRobot.changeStateOfGoogleApi(mMockedGoogleApiAvailability, true);
        CloudDataStoreTestRobot.changeHasLollipop(mCloudDataStore, true);
        assumeFalse(CloudDataStoreTestRobot.isNetworkEnabled(mMockedDBManager));
