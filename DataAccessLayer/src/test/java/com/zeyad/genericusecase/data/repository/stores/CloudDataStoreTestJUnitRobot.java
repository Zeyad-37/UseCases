...
import com.zeyad.genericusecase.data.db.RealmManagerImplJUnitUtils;
...
import com.zeyad.genericusecase.utils.ResponseBodyObservable;
import com.zeyad.genericusecase.utils.TestModel;
import com.zeyad.genericusecase.utils.TestModelViewModelMapper;
import com.zeyad.genericusecase.utils.TestUtility2;
import com.zeyad.genericusecase.utils.TestViewModel;
import com.zeyad.genericusecase.utils.ToStringArgumentMatcher;
...
class CloudDataStoreTestJUnitRobot {
    ...
    static DataBaseManager createDBManagerWithMockedContext() {
        ...
        final DataBaseManager dbManagerWithMockedContext
                = RealmManagerImplJUnitUtils.createDBManagerWithMockedContext();
    ...
    static TestSubscriber<Object> dynamicPostJsonObject(@NonNull CloudDataStore cloudDataStore, boolean toPersist) {
        ...
        cloudDataStore.dynamicPostObject(getValidUrl()
                , CloudDataStoreTestJUnitRobot.getValidColumnName()
                , createTestModelJSON()
                , getValidDomainClass()
                , getValidDataClass()
                , false
