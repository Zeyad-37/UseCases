...
class GenericGCMServiceJUnitTestRobot {
    ...
    static int runForDownloadFile() {
        ...
        genericGCMService.setContext(GenericGCMServiceJUnitTestRobot.getMockedContext());
        return genericGCMService.onRunTask(GenericGCMServiceJUnitTestRobot
