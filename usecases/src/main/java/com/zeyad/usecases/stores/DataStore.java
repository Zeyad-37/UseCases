...
public interface DataStore {
    ...
    @NonNull
    <M> Flowable<List<M>> dynamicGetList(String url, Class dataClass, boolean persist, boolean shouldCache);

    /**
     * Get an {@link Flowable} which will emit a Object by its id.
     */
    @NonNull
    <M> Flowable<M> dynamicGetObject(String url, String idColumnName, int itemId,
                                     Class dataClass, boolean persist, boolean shouldCache);

    /**
     * Search disk with a RealmQuery which returns an {@link Flowable} that will emit a list of Object.
     */
    @NonNull
    ...
    /**
     * Post a HashMap<String, Object> which returns an {@link Flowable} that will emit a list of Object.
     */
    @NonNull
    ...
    /**
     * Put a HashMap<String, Object> disk with a RealmQuery which returns an {@link Flowable}
    ...
    /**
     * Delete a HashMap<String, Object> from cloud which returns an {@link Flowable} that will emit a Object.
     */
    @NonNull
