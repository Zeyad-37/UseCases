...
public class ApiConnection {
    ...
    public static RestApi initWithCache(
        ...
        return createRetro2Client(provideOkHttpClient(okHttpBuilder == null ?
                                                      getBuilderForOkHttp() : okHttpBuilder, cache)).create(RestApi.class);
    }

    public static RestApi init(@Nullable OkHttpClient.Builder okHttpBuilder) {
        return createRetro2Client(provideOkHttpClient(okHttpBuilder == null ?
                                                      getBuilderForOkHttp() : okHttpBuilder, null)).create(RestApi.class);
    }
